...
public class OrOperator implements TwoParamOperator {
	...
	public OrOperator(int orderNum) {
	...
	public Box run(Box param1, Box param2) {
		...
		if (param1.getOriginBox().getInnerBox("or") != null)
			return param1.getOriginBox().getInnerBox("or").run(param2.getOriginBox());
		else throw new Error();
	}
}
