...
public class SmallEqualOperator implements TwoParamOperator {
	...
	public SmallEqualOperator(int orderNum) {
	...
	public Box run(Box param1, Box param2) {
		...
		if (param1.getOriginBox().getInnerBox("smallerOrEqualsThan") != null)
			return param1.getOriginBox().getInnerBox("smallerOrEqualsThan").run(param2.getOriginBox());
		else throw new Error();
	}
}
